<template>
  <div>
    ...
    <q-list bordered separator>
      <div class="cursor-pointer" v-for="item in posts">
        <post-component @done="getPosts" @view="emitView($event)" :item="item"/>
      </div>
    </q-list>
  </div>
</template>
    ...
    computed: {
      getUserScreenNameCaps() {
        ...
        if (this.getUser() != null) {
          this.getUser().screen_name.split(" ").forEach(s => caps += s.charAt(0))
        }
